...
Public Class YAMLCrpNPCCorporationDivisions
    ...
    Public Sub ImportData(FilePath As String, FileName As String, ByRef LabelRef As Label, ByRef PGRef As ProgressBar)
        ...
        SQL = "CREATE UNIQUE INDEX IDX_CID_DID ON " & TableName & " (corporationID, divisionID)"
        Call UpdateDB.ExecuteNonQuerySQL(SQL)
        ...
        For Each DataField In Languages
            ...
            SQL = SQL & YAMLTranslationDocument.GetSQLScalarValueFromMapping("size", DataField) & ")"
