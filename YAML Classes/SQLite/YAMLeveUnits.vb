...
Public Class YAMLeveUnits
    ...
    Public Sub ImportData(FilePath As String, FileName As String, ByRef LabelRef As Label, ByRef PGRef As ProgressBar)
        ...
        SQL = SQL & "unitID INTEGER PRIMARY KEY,"
        SQL = SQL & "unitName VARCHAR(100),"
        SQL = SQL & "displayName VARCHAR(50),"
        ...
        For Each DataField In Languages
            unitID = YAMLTranslationDocument.GetSQLScalarValueFromMapping("unitID", DataField)
            SQL = "INSERT INTO " & TableName & " VALUES ("
            SQL = SQL & unitID & ","
            SQL = SQL & UpdateDB.BuildSQLInsertStringValue(YAMLTranslationDocument.GetSQLScalarValueFromMapping("unitName", DataField)) & ","
            ...
            Call frmMain.UpdateProgress(LabelRef, PGRef, Count, FileName & " Record " & unitID)
        Next
